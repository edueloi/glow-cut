...
export const MODULE_META: ModuleMeta[] = [
  ...
  { key: "produtos",     label: "Produtos e Estoque", group: "operacional", actions: ["ver", "criar", "editar_todos", "excluir_todos"] },
  { key: "pacotes",      label: "Pacotes de Serviços", group: "operacional", actions: ["ver", "criar", "editar_todos", "excluir_todos"] },
  { key: "planos_assinatura", label: "Planos de Assinatura", group: "operacional", actions: ["ver", "criar", "editar_todos", "excluir_todos"] },
  { key: "comandas",     label: "Comandas / PDV",  group: "operacional", actions: ["ver", "criar", "editar_proprio", "editar_todos", "excluir_proprio", "excluir_todos", "financeiro"],
    splitActions: [
      { action: "editar",  own: "editar_proprio",  all: "editar_todos" },
      { action: "excluir", own: "excluir_proprio", all: "excluir_todos" },
    ],
